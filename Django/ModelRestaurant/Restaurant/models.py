...
class Modelrestaurant(models.Model):
    ...
    bsnscond = models.CharField(db_column='bsnsCond', max_length=20, blank=True,
    ...
    addrroad = models.CharField(db_column='addrRoad', max_length=100, blank=True,
                                null=True)  # Field name made lowercase.
    addrjibun = models.CharField(db_column='addrJibun', max_length=100, blank=True,
                                 null=True)  # Field name made lowercase.
    viewcnt = models.IntegerField(db_column='viewCnt', blank=True, null=True)  # Field name made lowercase.

class Meta:
    managed = False
    db_table = 'restaurant_modelrestaurant'
